...
<div class="space-y-8 animate-fadeIn">
    ...
    <!-- Header Section -->
    <x-admin.header 
        title="Profit & Loss Balance Ledger" 
        description="Specify calendar boundaries to generate audited balance sheets, compute net margins, and analyze operational profitability." 
    ...
    <div class="max-w-3xl mx-auto">
        <div class="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
            ...
            <form action="{{ route('admin.reports.pl.generate') }}" method="POST" target="_blank" class="space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <input type="date" name="startDateStr" id="startDateSelect" required onchange="formatDate(this, 'startDate')"
                            class="w-full bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-800 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="date" name="endDateStr" id="endDateSelect" required onchange="formatDate(this, 'endDate')"
                            class="w-full bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-xl px-4 py-3 text-sm text-slate-800 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition">
