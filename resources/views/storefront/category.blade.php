...
@section('content')
    ...
    <div class="mb-4">
        <div class="flex items-center gap-2 text-[11px] font-medium text-slate-500 mb-1.5">
            ...
            <i class="fa-solid fa-chevron-right text-[8px] text-slate-400"></i>
            <span class="text-slate-800 font-bold capitalize">{{ $category->cat_name }}</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start mb-16">
        ...
        <div class="lg:col-span-9 space-y-4">
            ...
            <div class="flex items-center justify-between bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 shadow-sm flex-wrap gap-3">
                <div>
                    <h1 class="text-base font-black text-slate-900 dark:text-white uppercase tracking-wide inline-block mr-2">{{ $category->cat_name }}</h1>
                ...
                <div class="flex items-center gap-2 text-xs">
                    ...
                    <select class="border border-slate-200 dark:border-slate-850 rounded-lg px-2.5 py-1.5 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 font-bold outline-none cursor-pointer">
            ...
            @else
                ...
                <div class="text-center py-16 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 max-w-sm mx-auto shadow-sm">
                    ...
                    <p class="text-[11px] text-slate-500 mt-2">There are currently no products available under the {{ $category->cat_name }} category.</p>
